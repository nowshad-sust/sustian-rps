    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-sm-6 text-center">
                <img src="frontend/img/property-img.png" alt="">
            </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul class="bxslider">
                <li>
                    <div class="element item view view-tenth" data-zlname="reverse-effect">
                        ...
                        <div class="mask">
                            ...
                            <a data-zl-popup="link2" class="fancybox" rel="group" href="frontend/img/works/img1.jpg">
                ...
                <li>
                    <div class="element item view view-tenth" data-zlname="reverse-effect">
                        ...
                        <div class="mask">
                            ...
                            <a data-zl-popup="link2" class="fancybox" rel="group" href="frontend/img/works/img2.jpg">
                                <i class="fa fa-search"></i>
                            </a>
                        </div>
                    </div>
                ...
                <li>
                    <div class="element item view view-tenth" data-zlname="reverse-effect">
                        ...
                        <div class="mask">
                            ...
                            <a data-zl-popup="link2" class="fancybox" rel="group" href="frontend/img/works/img3.jpg">
                                <i class="fa fa-search"></i>
                            </a>
                        </div>
                    </div>
                ...
                <li>
                    <div class="element item view view-tenth" data-zlname="reverse-effect">
                        ...
                        <div class="mask">
                            ...
                            <a data-zl-popup="link2" class="fancybox" rel="group" href="frontend/img/works/img4.jpg">
                                <i class="fa fa-search"></i>
                            </a>
                        </div>
                    </div>
                ...
                <li>
                    <div class="element item view view-tenth" data-zlname="reverse-effect">
                        ...
                        <div class="mask">
                            ...
                            <a data-zl-popup="link2" class="fancybox" rel="group" href="frontend/img/works/img5.jpg">
                                <i class="fa fa-search"></i>
                            </a>
                        </div>
                    </div>
                ...
                <li>
                    <div class="element item view view-tenth" data-zlname="reverse-effect">
                        <img src="frontend/img/works/img7.jpg" alt="" />
                        <div class="mask">
                            <a data-zl-popup="link" href="javascript:;">
                                <i class="fa fa-link"></i>
                            </a>
                            <a data-zl-popup="link2" class="fancybox" rel="group" href="frontend/img/works/img7.jpg">
                                <i class="fa fa-search"></i>
                            </a>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <ul class="list-unstyled">
                        <li><a href="#"><img src="frontend/img/clients/logo1.png" alt=""></a></li>
                        <li><a href="#"><img src="frontend/img/clients/logo2.png" alt=""></a></li>
                        <li><a href="#"><img src="frontend/img/clients/logo3.png" alt=""></a></li>
                        <li><a href="#"><img src="frontend/img/clients/logo4.png" alt=""></a></li>
                        <li><a href="#"><img src="frontend/img/clients/logo5.png" alt=""></a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<script type="frontend/text/javascript" src="js/hover-dropdown.js"></script>
