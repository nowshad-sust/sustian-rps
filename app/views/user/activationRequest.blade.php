...
<div class="container">
    {{ Form::open(array('route' => 'sendActivationLink', 'method' => 'post', 'class' => 'form-signin')) }}
    <h2 class="form-signin-heading">Get Activation Email</h2>
    <div class="login-wrap">
        ...
        {{ Form::submit('Send Email', array('class' => 'btn btn-lg btn-login btn-block')) }}
    </div>
